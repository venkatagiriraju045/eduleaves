        ...
        try {
            ...
            reader.onload = async (e) => {
                try {
                    ...
                    const semesterResultsToUpdate = excelData.map((data) => {
                        // Extract and format data from Excel sheet
                        return {
                            registerNumber: data.registerNumber,
                            semester_results: data.semester_results, // Assuming you have a column named 'semester_results'
                        };
                    });
