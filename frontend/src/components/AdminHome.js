...
return (
    ...
    <div>
        ...
        <p className="admin-header-dialogue">KNOWLEDGE INSTITUTE OF TECHNOLOGY</p>
    ...
    {showAttendanceOverlay && (
        ...
        <AdminAttendance students={students} />
        ) : (
        ...
        <p className='error-message'>No student data available.</p>
            ...
            <footer className="footer">&copy; 2023 Knowledge Institute of Technology. All rights reserved.<div className="download-button-container">
