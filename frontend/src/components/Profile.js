...
import Test_Score from './Test_Score';
...
const Profile = () => {
            ...
            plugins: [
                {
                    ...
                    afterDraw: (chart) => {
                        ...
                        ctx.font = "43px FjallaOne-Regular";
    ...
    }, [student, createChart, createAttendanceChart]);
    ...
    const handleShowTestScore = () => {
        ...
        document.querySelectorAll('.test-chart,.chart-container1,.profile-chart-container,.chart-details-container1, .attendance-chart, .overall-performance-chart,.analytics-container, .message-container, #scoreChart').forEach((element) => {
    ...
    const handleTestScoreClose = () => {
        ...
        setShowAttendance(false);
        document.querySelectorAll('.test-chart,.chart-container1,.chart-details-container1 ,.attendance-chart, .overall-performance-chart, .analytics-container, .message-container, #scoreChart').forEach((element) => {
    ...
    const handleShowAttendance = () => {
        ...
        // Hide the chart elements
        document.querySelectorAll('.test-chart,.chart-container1,.profile-chart-container,.chart-details-container1, .attendance-chart, .overall-performance-chart,.analytics-container, .message-container').forEach((element) => {
            element.style.display = 'none';
        });
    ...
    const handleCloseAttendance = () => {
        setShowAttendance(false);
        document.querySelectorAll('.test-chart,.chart-container1,.chart-details-container1 ,.attendance-chart, .overall-performance-chart,.analytics-container, .message-container').forEach((element) => {
            element.style.display = 'flex';
        });
    };
    ...
    const renderAnalytics = (student) => {
        // Check if the student object is null or undefined
        if (!student) {
    ...
    return (
        ...
        <div className="page-container">
            {showNavBar &&
                <nav className="navigation1">
                    <ul>
                        ...
                        <li>
                            <div>
                                <a href="#" className="test-score-button" onClick={handleShowTestScore}>Test Details</a>
                            </div>
                        </li>
                        <li>
                            <div>
            ...
            <div>
                <header
                    className={`admin-header ${showNavBar ? "with-nav-bar" : "without-nav-bar"
                        }`}>
            ...
            <main
                ...
                {showTestScore && <Test_Score email={student.email} department={student.department} year={student.class} onClose={handleTestScoreClose} />}
                <div className="profile-chart-container">

                    <div className='attendance-chart-container'>
                        <div className="test-chart" onClick={handleShowTestScore}>
                            <div className='chart-container1'>
                                <canvas id="scoreChart"></canvas>
                            </div>
                            <div className='chart-details-container1'>
                                <div className='chart-details1'>
                    ...
                    <div className='attendance-chart-container'>
                        <div className="attendance-chart" onClick={handleShowAttendance}>
                            <div className='chart-container1'>
