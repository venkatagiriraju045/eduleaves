            ...
            <div className="home-container">
                <div className="home-page-left-container">
                    <div className="home-page-main-logo-container">
                        <img src="../../public/uploads/tsg-logo.png" alt="menu image" id="home-page-main-logo" />
                    </div>
                ...
                <div className="home-page-right-container">
                    ...
                    <div className="login-container">
                        <div className='login-page-logo-container'>
                            <img src="../../public/uploads/login-page-logo.png" alt="menu image" id="login-page-logo" />
                        </div>
                        ...
                        <img src="../../public/uploads/login-page-line.png" alt="menu image" id="login-page-line" />
